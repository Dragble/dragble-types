...
export interface ModuleColumn {
  /** Column ID regenerated by the editor when saving/loading modules */
  id?: string;
...
export interface ModuleContent {
  /** Content ID regenerated by the editor when saving/loading modules */
  id?: string;
  type: string;
  values: Record<string, unknown>;
}
...
export interface ModuleData {
  /** Row ID regenerated by the editor when saving/loading modules */
  id?: string;
  cells: number[];
  columns: ColumnData[];
  values: Record<string, unknown>;
...
export interface ModulesTabConfig {
  ...
  /** Modules Library accordion configuration */
  modulesLibrary?: {
    visible?: boolean;
    defaultExpanded?: boolean;
    /** Title for the modules library accordion (default: "Modules Library") */
    title?: string;
    /** Category options shown in the Save Module modal. Values are normalized to lowercase. */
    categories?: string[];
    /** Default category selected in the Save Module modal. Value is normalized to lowercase. */
...
export interface ModuleSaveData {
  ...
  name: string;
  /** Module category (normalized to lowercase) */
  category: string;
...
export interface ModuleSaveResult {
  ...
  moduleId?: string;
  /** Stored module thumbnail URL (if returned by the host application) */
  thumbnail?: string;
}
...
export interface ModuleDeleteData {
  /** Module ID from the SDK-provided modules list */
  id: string;
  /** Module name for confirmation/logging */
  name?: string;
  /** Module category for confirmation/logging */
  category?: string;
  /** Module type - standard or synced */
  type?: ModuleType;
  /** Module mode - email or web */
  mode?: ModuleMode;
}
...
export type ModuleDeleteCallback = (
  data: ModuleDeleteData,
...
export interface PexelizeCallbacks {
  ...
  /** Called when user deletes a saved module (blocking — editor waits) */
  onModuleDelete?: (data: ModuleDeleteData) => Promise<ModuleDeleteResult>;
